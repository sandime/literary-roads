const RoadTrip = ({ items, onRemove, onClearAll, onClose }) => {
  return (
      ...
      <div className="flex-1 overflow-y-auto p-4">
        {items.length === 0 ? (
          ...
          <div className="flex flex-col items-center justify-center h-full text-center py-16">
            <svg
              className="w-16 h-16 text-starlight-turquoise/25 mb-5"
                ...
                <div className="flex items-start gap-3 pr-6">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="mb-1">
                      ...
                      {item.type === 'landmark' && (
                        <span className="text-paper-white font-bungee text-xs">✒️ LITERARY LANDMARK</span>
                      )}
                    </div>
