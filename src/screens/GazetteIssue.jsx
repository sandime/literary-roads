    ...
    fetchArchivedIssueBySlug(slug)
      .then(issue => {
        ...
        setData({
          ...
          festivalTrips:     issue.festivalTrips     || [],
          handSelected:      issue.handSelected      || [],
          dispatches:        issue.dispatches        || [],
          readersChoice:     issue.readersChoice     || [],
          literaryLandmarks: issue.literaryLandmarks || [],
          readingRoom:       issue.readingRoom       || [],
          headlights:        issue.headlights        || [],
          onTheRoad:         issue.onTheRoad         || [],
          waystation:        issue.waystation        || [],
          bookstoreQA:       issue.bookstoreQA       || [],
          theLongRoad:       issue.theLongRoad       || [],
          nyt:               issue.nyt               || null,
        });
      })
